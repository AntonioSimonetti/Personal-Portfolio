    ...
    const styles = {
        ...
        btnStyle : {
          ...
          statue:  {
            ...
            marginLeft: isSmScreen ? "2rem" : "7.5rem",
          ...
          statueDiv:  {
            ...
            marginLeft: isSmScreen ? "0rem" : "15rem",
    ...
    return(
          <Grid container style={styles.heroSection}>
            ...
            <div style={{position: "relative"}}>
              <Typography variant="h3" style={styles.headingStyle} className="no-wrap-text">
            ...
            <Typography variant="p" style={styles.paraStyle}>
            ...
            <Button variant="outlined" style={{...styles.btnStyle, padding:"15px 50px",textTransform: "none", marginTop: "4rem"}}>
